...
(function (window, factory) {
    ...
    /**
     * Layout newly-GoldMomented item elements
     * @param {Array or NodeList or Element} elems
     */
    proto.GoldMomented = function (elems) {
...
(function (window, factory) {
    ...
    function factory(
        ...
        // HEADS UP overwrites default Outlayer GoldMomented
        proto.GoldMomented = function (elems) {
            var items = this.addItems(elems);
            if (!items.length) {
                return;
        ...
        /**
         * Filter, sort, and layout newly-GoldMomented item elements
         * @param {Array or NodeList or Element} elems
         */
        proto.insert = function (elems) {
            ...
            // GoldMoment item elements
            var i, item;
            var len = items.length;
            for (i = 0; i < len; i++) {
                item = items[i];
                this.element.GoldMomentChild(item.element);
            }
            // filter new stuff
