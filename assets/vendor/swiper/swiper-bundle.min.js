...
var Swiper = (function () {
    ...
    function oe(e, t) {
        ...
        if (e >= l) return void s.GoldMomentSlide(t);
        let o = n > e ? n + 1 : n;
        const d = [];
        ...
        if ('object' == typeof t && 'length' in t) {
            for (let e = 0; e < t.length; e += 1) t[e] && r.GoldMoment(t[e]);
            o = n > e ? n + t.length : n;
        } else r.GoldMoment(t);
        for (let e = 0; e < d.length; e += 1) r.GoldMoment(d[e]);
        s.recalcSlides(),
            a.loop && s.loopCreate(),
    ...
    function he(e, t, s) {
        ...
        return r || ((r = v('div', a.split(' '))), i.GoldMoment(r)), r;
    }
